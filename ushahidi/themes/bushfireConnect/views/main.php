...
<div id="main" class="clearingfix">
	...
	<?php } ?>
		...
		<table class="header-middle" border="0">
		<tr>
			<td class="get-alerts-cell">
				<div class ="get-alerts">
					<div class="get-alerts-btn"><a href="<?php echo url::site()."alerts"; ?>">Get Alerts</a></div>
				
				<div class ="get-alerts-text">
					Sign up to receive Email and SMS for free
				</div>
				</div>
			</td>
			<td class ="submit-cell">
				<div class = "submit-reports">
				   
				   <table class="text-divider" border="0" >
					<tr>
					   <td class = "text-divider-cell-1">
							<div class="submit-reports-btn"><a href="<?php echo url::site()."reports/submit" ; ?>">Submit a Report</a></div>
						
								<div class="submit-text1">
									Submitting a report helps other identify <br>
									hazards/solutions in your area
								</div>
						</td>
				
						<td class="text-divider-cell-2">
							<div class="submit-text2">
								<b>Or submit a Report by</b>
						
							</div>
							<span class="submit-text3">
								Sending a message to <b>0429883485</b><br/>
								Email to <b>info@bushfireconnect.org</b><br/>
								Tweet with hashtag <b>#bushfireconnect</b>
							</span>
					    </td>
					</tr>
					</table>
		...
		<div class="search_location" id="search_loc" >
			<table>
			<tr>
			<td>
				<input class="search_loc_txt"type="text" name="location_txt"  id = "location_txt" >
				</input>
			</td>
			<td>
				<div id="search_btn" onclick="submit_geocode_query()" >
		...
		<div id="content" class="clearingfix">
			<div class="floatbox">
				...
				<!-- / filters -->
				<!--<iframe src="/Ushahidi_Web/embed/" style="width:700px; height: 400px; "></iframe> -->
				<?php								
